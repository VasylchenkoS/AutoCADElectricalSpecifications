...
Namespace com.vasilchenko.Modules
    Module KDItemListMaker
        Public Function MakeKDItemList(acDatabase As Database, acTransaction As Transaction) As SortedList(Of String, List(Of DrawingSpecificationItem))
